...
export async function POST(request: NextRequest) {
  try {
                ...
                <tr>
                  <td style="background-color:#ffffff; padding: 32px 40px;">
                    <p style="margin:0 0 20px 0; font-size:14px; color:#6b7280; line-height:1.6;">
                      A new "Contact Us" form submission has been received. Review the message details below.
                    </p>
    ...
    const mailOptions = {
      ...
      subject: `New Contact Submission — ${submittedAt}`,
      html: htmlEmail,
    };
    ...
    return NextResponse.json({ success: false, error: "Failed to submit contact message" }, { status: 500 });
  }
}
